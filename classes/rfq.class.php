...
class rfq
{
	...
	{	  
		...
		if((!empty($_POST['quoteok']))&&($_POST['quoteok']=='ok'))
		{
			 ...
			 $sql2="update tbl_RFQ_3 set Fld_RFQ_ID='".$_POST['Fld_RFQ_ID']."',Fld_Part_Id='".$_POST['Fld_Part_ID']."',Fld_Part_SN='".$_POST['Fld_Part_SN']."',Fld_Qty='".$_POST['Fld_Qty']."',Fld_Condition='".$_POST['Fld_Condition_ID']."',Fld_Price='".$_POST['Fld_Price']."',Fld_Currency_ID='".$_POST['FldCurrencyID']."',Fld_Remark='".$_POST['Fld_Remark']."',Fld_Traceability_ID='".$companyidrecuptrac."',Fld_Tag_Info_ID='".$companytaginforecup."',Fld_Tag_Date='".$_POST['Fld_Tag_Date']."',Fld_Release_ID='".$_POST['Fld_Release_ID']."',moq='".$_POST['moq']."',lead_time='".$_POST['lead_time']."',Fld_Priority_ID='".$_POST['Fld_Priority_ID']."',rfqvalid='".$_POST['rfqvalid']."',source_type='".$source_type."',source_id='".$source_id."' where ID='".$_POST['idrfq3']."'";
		 // echo $sql2;
		...
		else
		{
			...
			$source_type = !empty($_POST['selected_source_type']) ? $_POST['selected_source_type'] : (!empty($_POST['source_type']) ? $_POST['source_type'] : '');
			$source_id = !empty($_POST['selected_source_id']) ? (int)$_POST['selected_source_id'] : (!empty($_POST['source_id']) ? (int)$_POST['source_id'] : 0);
			$sql="INSERT INTO `tbl_RFQ_3` (`ID`, `Fld_RFQ_ID`, `Fld_Quote_Date`, `Fld_Part_Id`, `Fld_Part_SN`, `Fld_Qty`, `Fld_Condition`, `Fld_Price`, `Fld_Price_Min`, `Fld_Price_Max`, `Fld_Currency_ID`, `Fld_Remark`, `Fld_Supply_Date`, `Fld_Traceability_ID`, `Fld_Tag_Info_ID`, `Fld_Tag_Date`, `Fld_Release_ID`, `Fld_Linked_ID`, `Fld_Exch_Core_Value`, `Fld_Exch_Core_Value_Currency_ID`, `Fld_Exch_Cond`, `Fld_IsBeen_Chosen`, `Fld_Send_Mail`, `Fld_Exch_Core_RCVD`, `moq`, `lead_time`, `Fld_Priority_ID`, `id_tbl_rfq1`, `source_type`, `source_id`) VALUES (NULL, '".$_POST['Fld_RFQ_ID']."', '".$datequote."', '".$_POST['part_id']."', '".$_POST['Fld_Part_SN']."', '".$_POST['Fld_Qty']."', '".$_POST['Fld_Condition_ID']."', '".$_POST['Fld_Price']."', '', '', '".$_POST['FldCurrencyID']."', '".$_POST['Fld_Remark']."', '', '".$companyidrecuptrac."', '".$companytaginforecup."', '".$_POST['Fld_Tag_Date']."', '".$_POST['Fld_Release_ID']."', '', '', '', '', '', '', '', '".$_POST['moq']."', '".$_POST['lead_time']."', '".$_POST['Fld_Priority_ID']."', '".$_POST['idrfq1']."', '".$source_type."', '".$source_id."');";
		// echo $sql;
		 $requete = mysql2_query($sql);
