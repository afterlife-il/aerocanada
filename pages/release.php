                ...
                <div class="col-lg-10">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="javascript:addrelease()"> + Add a Release</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_release.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									$objet=new release();
									$donnee = $objet->affichage_release();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Release_ID"]."\"><td>".$dataemp["Fld_Release_ID"]."</td><td><input type='text' name='Fld_Release_Text' value='".$dataemp['Fld_Release_Text']."' id='Fld_Release_Text".$dataemp["Fld_Release_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Release_ID"].")'><input type=\"hidden\" name=\"nbrelease\" id=\"nbrelease\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:supp_release(".$dataemp["Fld_Release_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add currency-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Release_Text\" id=\"Fld_Release_Text\" placeholder=\"Release Name\"><input type='hidden' name='nbrelease' value='"+nbLignes+"'>";
...
<!--End add currency-->
<!--Sup currency-->
function supp_release(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_release.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Release_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp currency-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Release_Text"+id).value;
    $.get('majrelease.php', { // lien de la page qui permet la suppression
                Fld_Release_ID:id,Fld_Release_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
