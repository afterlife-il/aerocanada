        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header">PRICE LIST <?php if($_GET['Fld_Company_ID']=='1182') echo "THALES AVIONICS ELECTRICAL SYSTEMS SAS - TAES (AUXILEC-THALES)";?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
