...
$html = '<body style="height: 100%;margin: 0;padding: 0;width: 100%;font-size: 12px;">
		...
		<tr><td style="width: 16%;"><img src="'.$_SERVER["DOCUMENT_ROOT"].'/adminaero/pages/images/logo-aerocanada.png" style="padding:5px;width:100px;"></td>
		<td align="left" style="width: 42%;">
		<h3>AEROCANADA INDUSTRIES 770 INC.</h3>
		99, Princ e Street, 7th Floor, Suite#701<br>
