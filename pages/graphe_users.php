...
<head>
	...
	$today = date("Y-m-d");
	$avant = date('Y-m-d', strtotime('-1 month'));
	?>
         ...
         "data": [
          <?php
						    ...
						    while($dataeid = mysqli_fetch_array($reqeid))
							{
								...
								$sqlc="SELECT count(*) AS totale FROM tbl_connection where Employee_ID='".$dataeid['Employee_ID']."' and connection_date BETWEEN '".$avant."' and '".$today."'";
								//echo $sqlc;
