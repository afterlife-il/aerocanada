...
$optionsimport=$_POST['optionsimport'];
echo $optionsimport;
$nb_champs_csv=$_POST['nb_champs_csv'];
echo $nb_champs_csv."<br>";
$Fld_Stock_Remark=$_POST['Fld_Remark']." ** ";
echo $Fld_Remark."<br>";
$csvcompany=$_POST['csvcompany'];
// echo $csvcompany."<br>";
$Fld_Company_ID=$_POST['companyid'];
...
//Part Number;Alternate Part Number;Description;Condition;Quantity;;;;
		...
		// if ($varoy=='5') $QTY=$val;
			...
			$varaff=$_POST['var'.$varoy];
			
			if ($varaff=='COMMENT')
			{
				$Fld_Stock_Remark.= $val." ** ";
			}
			if ($varaff=='PN')
			{
				$Fld_Part_Nbr=$val;
			}
			if ($varaff=='DESCRIPTION')
			{
				$FLD_PART_DESC=$val;
			}
			if ($varaff=='QTY')
			...
			if ($varaff=='APPLICABILITY')
			{
				$Fld_Stock_Remark.= "APPLICABILITY : ".$val." ** ";
			}
			if ($varaff=='SN')
			{
				$Fld_Stock_Remark.= "SN : ".$val." ** ";
			}
			if ($varaff=='Alternate_pn')
			{
				$Fld_Stock_Remark.= "Alternate pn :".$val." ** ";
			}
