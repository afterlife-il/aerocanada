                ...
                <div class="col-lg-4">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            RFQ TERMS<a href="javascript:add_rfq_terms()"> + Add A RFQ TERMS</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_rfq_terms.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									$objet=new rfq();
									$donnee = $objet->affichage_rfq_terms();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Payment_Term_ID"]."\"><td>".$dataemp["Fld_Payment_Term_ID"]."</td><td><input type='text' name='Fld_Payment_Text' value='".$dataemp['Fld_Payment_Text']."' id='Fld_Payment_Text".$dataemp["Fld_Payment_Term_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Payment_Term_ID"].")'><input type=\"hidden\" name=\"nbrrfqterms\" id=\"nbrrfqterms\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:sup_rfq_terms(".$dataemp["Fld_Payment_Term_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add RFQ Terms-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Payment_Text\" id=\"Fld_Payment_Text\" placeholder=\"RFQ Terms\"><input type='hidden' name='nbrrfqterms' value='"+nbLignes+"'>";
...
<!--End add RFQ Terms-->
<!--Sup RFQ Terms-->
function sup_rfq_terms(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_rfq_terms.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Payment_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp RFQ Terms-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Payment_Text"+id).value;
    $.get('majrfqterms.php', { // lien de la page qui permet la suppression
                Fld_Payment_Term_ID:id,Fld_Payment_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
