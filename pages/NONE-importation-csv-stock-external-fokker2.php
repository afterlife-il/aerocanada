<?php
$fop = fopen('csv/FS_ATR-Boeing-Airbus_Rotables-FOKKER-051118.csv', 'r');
if($fop === false)
{
...
//PARTNUMBER;DESCRIPTN;PO Serial No;Sales Price;TAT;Applicability
		if ($varoy=='1') $Fld_Part_Nbr=$val;
		if ($varoy=='2') $FLD_PART_DESC=$val;
		if ($varoy=='3') $PO_Serial_No=$val;
		if ($varoy=='4') $Sales_Price=$val;
		if ($varoy=='5') $TAT=$val;
		if ($varoy=='6') $Applicability=$val;
		
		$entry_date="2018-11-06";
		$Fld_Stock_Remark ="PO SERIAL NO : ".$PO_Serial_No." ** ";

		$Fld_Stock_Remark .=" TAT :".$TAT." ** ";
