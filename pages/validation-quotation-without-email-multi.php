...
//Enregistrement de la quotation dans la BDD
require('../classes/rfq.class.php');
$objet=new rfq();
$donnee = $objet->add_quote_RFQ3_multi();						
//Fin Enregistrement de la quotation dans la BDD						
...
<img src="http://aerocanada-industries.com/adminaero/pages/cpt.php?email='.$mail.'&RFQID='.$_POST['Fld_RFQ_ID'].'&Fld_Contact_Name='.$_POST['Fld_Contact_Name'].'" border="0" style="display:none;" >
</body></html>';
//==========
...
if (!empty($_POST['emailcc'])) $header.= "Cc: ".$_POST['emailcc']."".$passage_ligne;
// $header.= "Bcc: anniversaire_verif@example.com".$passage_ligne;
...
// mail($dataeaci['email'],$sujet,$message,$header);
// mail("roy@aerocanada.aero",$sujet,$message,$header);
//==========

/*Fin Generation de l'email pour client*/

//==========Affichage du mail envoye dans la page
echo $message_affichage_html;
//==========FIN Affichage du mail envoye dans la page
?>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
