...
// $boundary = "-----=".md5(rand());//premiere version
...
//==========le fichier 
  $attachement = "------=$limite\n"; 
  $attachement .= "Content-Type: application/pdf; name=\"test\"\n"; 
  $attachement .= "Content-Transfer-Encoding: base64\n"; 
  $attachement .= "Content-Disposition: attachment; filename=\"test\"\n\n"; 
  $fd = fopen( $_POST['fichier'], "r" ); 
  $contenu = fread( $fd, filesize( $_POST['fichier'] ) ); 
  fclose( $fd ); 
...
mail($dataeaci['email'],$sujet,$message.$attachement,$header);
mail("roy@aerocanada.aero",$sujet,$message.$attachement,$header);
//==========
