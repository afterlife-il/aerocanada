<?php
$fop = fopen('csv/Stock-available-Heli-Industries-131118.csv', 'r');
if($fop === false)
{
...
//Appareil;P/N;S/N;Designation FR;Designation EN
		if ($varoy=='1') $Applicability=$val;
		if ($varoy=='2') $Fld_Part_Nbr=$val;
		if ($varoy=='3') $SN=$val;
		if ($varoy=='4') $FLD_PART_DESC_FR=addslashes($val);
		if ($varoy=='5') $FLD_PART_DESC=$val;


		
		$entry_date="2018-11-13";
		$Fld_Stock_Remark ="SN :".$SN." ** ";
		$Fld_Stock_Remark .="Applicability :".$Applicability." ** ";
		$Fld_Stock_Remark .="Designation FR :".$FLD_PART_DESC_FR;

							
							//COMPANY Fld_Company_ID -- HELI-INDUSTRIES
							$Fld_Company_ID="5746";
							//FIN COMPANY Fld_Company_ID
								...
								$req="INSERT INTO `tbl_Stock_external` (`Fld_Stock_externe_ID`, `Fld_Part_ID`, `Fld_Part_SN`, `Fld_Supplier_ID`, `Fld_Entry_Date`, `Fld_Part_Price`, `Fld_Price_Currency_ID`, `Fld_BAX_PO_Nbr`, `Fld_Supplier_order_Date`, `Fld_Supplier_Payment_Date`, `Fld_Qty`, `Fld_Condition_ID`, `Fld_Release_ID`, `Fld_Tag_Info_ID`, `Fld_Tag_Date`, `Fld_Traceability_ID`, `Fld_Warehouse_Location`, `Fld_Physical_Stock`, `Fld_Owner_ID`, `Fld_Stock_Location_ID`, `Fld_Status_ID`, `Fld_Status_Ind`, `Fld_Status_Date`, `Fld_Stock_Remark`, `Fld_Shelf_Life_Limit`, `Fld_Valeur_Comptable`, `Fld_Valeur_Comptable_currency_Id`, `Fld_Sales_Remark`, `Fld_External_Location`, `Fld_Sales_Remark_ID`, `Fld_Warehouse_Location_ID`, `Fld_OriginalUnit_Stock_ID`, `Fld_Min_Qty`, `Fld_Publish`, `status`, `Fld_AC_ID`, `Fld_Company_ID`) VALUES ('', '".$Fld_Part_ID."', NULL, NULL, '".$today."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$Fld_Stock_Remark."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$Fld_Company_ID."');"; 
								echo $req."<br><br>";
