<?php
$fop = fopen('csv/2018-08-SR-TECH-SPAIN.csv', 'r');
if($fop === false)
{
...
//QTY;DESIGNATION;A/C;P/N;CONDITION;COMMENTS
		if ($varoy=='4') $Fld_Part_Nbr=$val;
		...
		if ($varoy=='6') $Fld_Stock_Remark=$val;

		
							//model avion 	
							if ($varoy=='3') $Fld_AC_ID=$val;
							//Fin model avion 	
							//COMPANY Fld_Company_ID 
							//COMPANY : SR-TECH-SPAIN
							$Fld_Company_ID="3182";
