<?php
$fop = fopen('csv/01-05-18-MIAMI-Aerocanada-stock.csv', 'r');
if($fop === false)
{
...
//;SHELF;PN;DESC;QTY;;COND;SN;TAG INFO;TAG INFO;TAG DATE
		...
		if ($varoy=='11') $DATE=$val;
											...
											//position in the stock (shelf)
											$Fld_Warehouse_Location="SHELF : ".$COMMENTS." / ".$COMMENTS2;
											
											$Fld_Sales_Remark="TAG INFO : ".$TAG_INFO." - CERTIFICATE : ".$CERTIF;
											
											$today = date("Y-m-d");
											
								$req="INSERT INTO `tbl_Stock` (`Fld_Stock_ID`, `Fld_Part_ID`, `Fld_Part_SN`, `Fld_Supplier_ID`, `Fld_Entry_Date`, `Fld_Part_Price`, `Fld_Price_Currency_ID`, `Fld_BAX_PO_Nbr`, `Fld_Supplier_order_Date`, `Fld_Supplier_Payment_Date`, `Fld_Qty`, `Fld_Condition_ID`, `Fld_Release_ID`, `Fld_Tag_Info_ID`, `Fld_Tag_Date`, `Fld_Traceability_ID`, `Fld_Warehouse_Location`, `Fld_Physical_Stock`, `Fld_Owner_ID`, `Fld_Stock_Location_ID`, `Fld_Status_ID`, `Fld_Status_Ind`, `Fld_Status_Date`, `Fld_Stock_Remark`, `Fld_Shelf_Life_Limit`, `Fld_Valeur_Comptable`, `Fld_Valeur_Comptable_currency_Id`, `Fld_Sales_Remark`, `Fld_External_Location`, `Fld_Sales_Remark_ID`, `Fld_Warehouse_Location_ID`, `Fld_OriginalUnit_Stock_ID`, `Fld_Min_Qty`, `Fld_Publish`, `status`) VALUES ('', '".$Fld_Part_ID."', '".$SN."', NULL, '".$today."', NULL, NULL, NULL, NULL, NULL, '".$QTY."', '".$dataidcon['Fld_Condition_ID']."', NULL, NULL, '".$DATE."', NULL, '".$Fld_Warehouse_Location."', NULL, NULL, '15', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$Fld_Sales_Remark."', NULL, NULL, NULL, NULL, NULL, NULL, '');"; 
									// echo $req."<br><br>";
