                ...
                <div class="col-lg-10">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            <a href="javascript:addcurrency()"><img src="images/logo-currency.jpg" width="50"> + Add a Currency</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_currency.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									$objet=new currency();
									$donnee = $objet->affichage_currency();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Currency_ID"]."\"><td>".$dataemp["Fld_Currency_ID"]."</td><td><input type='text' name='Fld_Currency_Text' value='".$dataemp['Fld_Currency_Text']."' id='Fld_Currency_Text".$dataemp["Fld_Currency_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Currency_ID"].")'><input type=\"hidden\" name=\"nbCurrency\" id=\"nbCurrency\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:supp_currency(".$dataemp["Fld_Currency_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add currency-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Currency_Text\" id=\"Fld_Currency_Text\" placeholder=\"Currency Name\"><input type='hidden' name='nbCurrency' value='"+nbLignes+"'>";
...
<!--End add currency-->
<!--Sup currency-->
function supp_currency(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_currency.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Currency_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp currency-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Currency_Text"+id).value;
    $.get('majcurrency.php', { // lien de la page qui permet la suppression
                Fld_Currency_ID:id,Fld_Currency_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
