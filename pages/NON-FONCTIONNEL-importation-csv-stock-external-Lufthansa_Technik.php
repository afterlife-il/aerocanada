<?php
$fop = fopen('csv/STOCK_LUFTHANSA_TECHNIK_11_16_2018_MaterialList.csv', 'r');
if($fop === false)
{
...
//PN;Description;ATA;A/C Type
		if ($varoy=='1') $Fld_Part_Nbr=$val;
		if ($varoy=='2') $FLD_PART_DESC=$val;
		if ($varoy=='3') $TAT=$val;
		if ($varoy=='4') $Applicability=$val;
		
		$entry_date="2018-11-16";
		$Fld_Stock_Remark ="TAT : ".$TAT." ** ";
		$Fld_Stock_Remark .=" Applicability :".$Applicability;
							
							//COMPANY Fld_Company_ID -- LUFTHANSA TECHNIK COMPONENT SERVICES, FLL UC42
							$Fld_Company_ID="4917";
