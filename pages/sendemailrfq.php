...
<?php include "after_nav.php"; ?>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Validation RFQ</h1>
					</div>
				</div>	
...
//=====Définition du sujet.
$sujet = "RFQ / AEROCANADA / PN# ".$_POST['Fld_Part_Nbr'];
//=========
...
//=====Envoi de l'e-mail.
	...
	//recuperation information compte google employee
	...
	//END module envoi email par gmail
	//*******************************************************************************************************
if(!empty($_POST['fast_send'])){
...
foreach($tags as $key) {
	...
	//********************************************************************
	$result = smtpMailer($key, $emailemplo, $Employee_Name, $sujet, $message_html_fast,$emailemplo,$pwgmaero);
	//********************************************************************
}
