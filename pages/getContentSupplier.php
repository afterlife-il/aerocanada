						...
						<div class="row">
								<div class="col-lg-5">
										<div class="form-group has-warning">
                                            <label>RFQ ID</label>
                                            <input type="text" class="form-control" name="Fld_RFQ_ID" value="<?php echo $data["Fld_RFQ_ID"];?>">
                                        </div>
								</div>
								...
								<div class="col-lg-5">
										<div class="form-group has-warning">
                                            <label>DATE</label>
                                            <input type="text" class="form-control" name="RFQ_DATE" value="<?php echo $data["date"];?>">
                                    </div>
								</div>
							...
							<div class="row">
									<div class="col-lg-3">
										<div class="form-group has-warning">
                                            <label>PN</label>
                                            <input type="text" class="form-control" name="pn_rfq" id="pn_rfq" value="<?php echo $data["pn_rfq"];?>"> 
                                        </div>
									</div>
									<div class="col-lg-4">
										<div class="form-group has-warning">
                                            <label>DESCRIPTION</label>
                                            <input type="text" class="form-control" name="description_rfq" id="description_rfq" value="<?php echo $data['description_rfq'];?>">
                                        </div>
                                    </div>
									<div class="col-lg-2">
										<div class="form-group has-warning">
                                            <label>QTY</label>
                                            <input type="text" class="form-control" name="Fld_Qty" id="Fld_Qty" value="<?php echo $data['Fld_Qty'];?>">
                                        </div>
                                    </div>
									<div class="col-lg-3">
										<div class="form-group has-warning">
							...
							<hr>
							<!--Je verifie si un supplier a ete saisie pour ce rfq-->
							<?php
							...
							$resultrfq2 = mysql2_query("SELECT * FROM tbl_RFQ_2 where ID='".$_GET['id']."'");											
							$num_rows_rfq2 = mysqli_num_rows($resultrfq2);
							if(0<$num_rows_rfq2){
							$datarfq2 = mysqli_fetch_array($resultrfq2);
							}
								?>
							<!--Je verifie si un supplier a ete saisie pour ce rfq-->
							<div class="row">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											$sqltirecup="SELECT Fld_Company_Name FROM tb_company WHERE Fld_Company_ID='".$datarfq2['Fld_Tag_Info_ID']."'";
											$reqtirecup = mysql2_query($sqltirecup);
											$datatirecup = mysqli_fetch_array($reqtirecup);
											//Fin recuperation du nom de compagnie TAG INFO********************
											?>
                                            <input type="text" name="Fld_Tag_Info_ID" id="Fld_Tag_Info_ID" class="Fld_Tag_Info_ID" value="<?php if (!empty($datarfq2['Fld_Tag_Info_ID'])) echo $datatirecup['Fld_Company_Name'].",".$datarfq2['Fld_Tag_Info_ID'];?>">
                                        </div>
									</div>
									<div class="col-lg-3">
										<div class="form-group">
                                            <label>TAG DATE</label>
                                            <input type="text" class="form-control" name="Fld_Tag_Date" id="Fld_Tag_Date" value="<?php echo $datarfq2['Fld_Tag_Date'];?>">
                                        </div>
									</div>
									<div class="col-lg-4">
										<div class="form-group">
											...
											$sqlttrecup="SELECT Fld_Company_Name FROM tb_company WHERE Fld_Company_ID='".$datarfq2['Fld_Traceability_ID']."'";
											...
											?>
											<input type="text" name="Fld_Traceability_ID" id="Fld_Traceability_ID" class="Fld_Traceability_ID" value="<?php if (!empty($datarfq2['Fld_Traceability_ID'])) echo $datattrecup['Fld_Company_Name'].",".$datarfq2['Fld_Traceability_ID'];?>">
                                        </div>
									</div>
						   ...
						   <div class="row">
									<div class="col-lg-4">
										<div class="form-group">
											...
											while($datar = mysqli_fetch_array($reqr)){
												...
												if($datar['Fld_Release_ID']==$datarfq2['Fld_Release_ID']) echo " selected";
									...
									<div class="col-lg-3">
										<div class="form-group">
                                            <label>SN</label>
                                            <input type="text" class="form-control" name="Fld_Part_SN" id="Fld_Part_SN" value="<?php echo $datarfq2['Fld_Part_SN'];?>">
                                        </div>
                                    </div>
						   ...
						   <div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
                                            <label>PRICE</label> <span style="color:#A7142A">(Prix supplier : <?php echo $datarfq2['Fld_Price'];?>)</span>
                                            <input type="text" class="form-control" name="Fld_Price" id="Fld_Price">
                                        </div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											...
											while($datacid = mysqli_fetch_array($reqcid)){
												...
												if($datacid['Fld_Currency_ID']==$datarfq2['Fld_Currency_ID']) echo " selected";
							...
							<div class="row">
									<div class="col-lg-10">
										<div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="Fld_Remark" id="Fld_Remark"><?php echo $datarfq2['Fld_Remark'];?></textarea>
                                        </div>
                                    </div>
