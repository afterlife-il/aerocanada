...
// Sécuriser part_id et id_utilisateur
$partId = isset($_GET['part_id']) ? (int) $_GET['part_id'] : 0;
$userId = isset($_SESSION['id_utilisateur']) ? (int) $_SESSION['id_utilisateur'] : 0;
if ($partId <= 0) { echo "<meta http-equiv=\"refresh\" content=\"0; url=pn.php\">"; exit; }

// maakav pn (journal de visite)
$today = date("Y-m-d");
$heuretoday = date("H:i:s");
mysql2_query(
  "INSERT INTO `tbl_maakav_pn` (`id_maakav_pn`, `id_part`, `datepn`, `heurevisitepn`, `id_Employee`)
   VALUES (NULL, {$partId}, '{$today}', '{$heuretoday}', {$userId})"
);
...
<link href="../dist/css/aci-overrides.css" rel="stylesheet"> <!-- <= impératif, et APRÈS sb-admin-2.css -->
    ...
    <![endif]-->
<style>
  .acc-link{display:block;text-decoration:none;color:inherit;cursor:pointer}
</style>
...
<?php include "after_nav.php"; ?>
        ...
        <div id="page-wrapper">
			...
			<div class="row">
                <div class="col-lg-12">
                	<div class="panel-group" id="pn-accordion">
                    <div class="panel panel-default">
 					 	<div class="panel-heading">
  <a data-toggle="collapse" href="#sec-part-number" aria-expanded="true" class="acc-link">PART NUMBER</a>
</div>
                  	<div id="sec-part-number" class="panel-collapse collapse in">
                        <!-- /.panel-heading -->
...
/* Table tbl_Parts :::: Fld_Part_ID  Fld_Part_Nbr  Fld_Part_Desc  Fld_Part_MFG  Fld_Part_MFG_Old  Fld_AC_ID  Fld_Old_LP  Fld_Part_List_Price  Fld_Part_Price_Currency_ID  Fld_Part_LP_Date  Fld_Remark status alt_pn*/
			...
			<!--*************************************************************************************************************-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                    	<?php
						    $sqldapn="SELECT * FROM tbl_docs_attachment_pn where pn_id='".$partId."'"; // si tu as déjà $partId, sinon garde $_GET
						    $reqdapn = mysql2_query($sqldapn);
						    $numrows_docattach = mysqli_num_rows($reqdapn);
						    $opened = ($numrows_docattach > 0) ? 'true' : 'false';
						    $inClass = ($numrows_docattach > 0) ? 'in' : '';
						  	?>
                        <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-docs" aria-expanded="<?php echo $opened; ?>" class="acc-link">DOCS ATTACHMENT</a>
</div>
						  <div id="sec-docs" class="panel-collapse collapse <?php echo $inClass; ?>">
						    <div class="panel-body" id="docattach" style="padding-bottom: 1px;">
                        <!-- /.panel-heading -->
						<!--************************************************-->
						<!--Verif si il y a des produits en stock pour ce pn-->
						<?php
							//affichage info docs part
					        $sqldapn="SELECT * FROM tbl_docs_attachment_pn where pn_id='{$partId}'";
			...
			<input type="hidden" name="pn" value="<?php echo $data["Fld_Part_Nbr"];?>">
						...
						<?php if ($numrows_docattach > 0): ?>
      <div id="docattach-list" class="table-responsive">
						<table>
						<?php
		...
		<div class="row">
			<!--Request for quotation-->
                <div class="col-lg-12">
                    <div class="panel panel-default">
                      <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-rfq-quote" aria-expanded="true" class="acc-link">RFQ & QUOTE</a>
</div>
						  <div id="sec-rfq-quote" class="panel-collapse collapse in">
                        <!-- /.panel-heading -->
							...
							<div class="row">
								<div class="col-lg-2">
										<div class="form-group has-warning">
											...
											<input type="text" name="companyid" id="companyid" class="companyid" placeholder="Please Enter company" onclick="javascript:majtareaback();"><a data-toggle="modal" data-target="#myModal" style="cursor: pointer;"><i style='margin-left:10px;top: 4px;font-size:23px;' class='fa fa-plus-circle '></i></a><br>
                                        </div>
								</div>
			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
  						<div class="panel-heading">
  <a data-toggle="collapse" href="#sec-quotation" aria-expanded="true" class="acc-link">QUOTATION</a>
</div>
                    <div id="sec-quotation" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
...
?>					
			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-stock" aria-expanded="true" class="acc-link">
    STOCK
  </a>
  <a href="ajout_stock.php" style="color:white;"><i style='margin-left:10px;position: relative;top: 4px;font-size:23px;' class='fa  fa-plus-circle'></i> ADD STOCK</a>
</div>
                        <div id="sec-stock" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
                        <!-- /.panel-heading -->
						<!--************************************************-->
						<!--Verif si il y a des produits en stock pour ce pn-->
			...
			<!--Fin STOCK select to quote-->
			 ...
			 <div class="row" id='blocstock' style='display:none'>
                <div class="col-lg-12" id='divstock'>
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-pn-details" aria-expanded="true" class="acc-link">PN DETAILS</a>
</div>
                        <div id="sec-pn-details" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
                        <!-- /.panel-heading -->
...
*/
						...
						<div class="row">
								<div class="col-lg-3">
										<div class="form-group">
                                            ...
                                            <input class="form-control" name="Fld_Part_ID" value="<?php echo $partId; ?>">
                                        </div>
								</div>
								<div class="col-lg-3">
										<div class="form-group">
			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-suppliers" aria-expanded="true" class="acc-link">SUPPLIERS QUOTE</a>
  <a href='javascript:windowaddsqpn();' style="top: 4px;color:#fff;text-decoration: none;"><i style='margin-left:10px;position: relative;top: 4px;font-size:23px;' class='fa  fa-plus-circle'></i> ADD A SQ</a>
                        ...
                        <div id="sec-suppliers" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
                        <!-- /.panel-heading -->
						<!--************************************************-->
			...
			<!--***************************************ADD SQ*********************************************-->
			 <div class="row" id="addpnsq" style='display:none'>
                <div class="col-lg-12">
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-add-sq" aria-expanded="true" class="acc-link">ADD SUPPLIERS QUOTE</a>
</div>
                        <div id="sec-add-sq" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-rfqs" aria-expanded="true" class="acc-link">REQUEST FOR QUOTATION</a>
  <a href="add_rfq.php" style="color:white;"><i ...></i> ADD MULTIPLE RFQ</a>
</div>
                        <div id="sec-rfqs" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
                        <!-- /.panel-heading -->
						<!--************************************************-->
						...
						<?php
							//****tbl_RFQ_1****ID Fld_RFQ_ID  Fld_Qty  Fld_Part_ID  Fld_Observation  Fld_Customer_ID date  Fld_RFQ_Type_ID  Fld_Priority_ID  Employee_ID  id_company_contact  Fld_Payment_Term_ID  Fld_Condition_ID pn_rfq description_rfq
							$sqlrfq3="SELECT tbl_RFQ_1.*,tb_company.Fld_Company_Name
          FROM tbl_RFQ_1,tb_company
          WHERE tbl_RFQ_1.Fld_Customer_ID=tb_company.Fld_Company_ID
            AND tbl_RFQ_1.Fld_Part_ID='{$partId}'
          ORDER BY ID Desc";
							//echo $sqlrfq3;
							$reqrfq3 = mysql2_query($sqlrfq3);
...
?>					
			...
			<!--Envoie email RFQ-->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
  <div class="panel-heading">
  <a data-toggle="collapse" href="#sec-send-rfq" aria-expanded="true" class="acc-link">SEND RFQ</a>
</div>
                        <div id="sec-send-rfq" class="panel-collapse collapse in"><!-- retirer "in" si tu veux fermé par défaut -->
    <div class="panel-body">
                        <!-- /.panel-heading -->
                        <div class="panel-body" id="sendrfq" style="padding-bottom: 1px;display:none;">              
						   ...
						   <?php
/* Table tbl_Parts :::: Fld_Part_ID  Fld_Part_Nbr  Fld_Part_Desc  Fld_Part_MFG  Fld_Part_MFG_Old  Fld_AC_ID  Fld_Old_LP  Fld_Part_List_Price  Fld_Part_Price_Currency_ID  Fld_Part_LP_Date  Fld_Remark status alt_pn*/
$sql="SELECT * from tbl_Parts where Fld_Part_ID='{$partId}' and status='Available'";
					$req = mysql2_query($sql);
					$data = mysqli_fetch_array($req);
            ...
            <div class="modal-body">
                <div class="container-fluid">
					<div class="row">
						...
						<div class="col-md-4">
							<label for="myPopupInputdescription" class="col-form-label">ADDRESS:</label>
							<input type="text" class="form-control" id="myPopupInputaddcompany" />
						</div>
					</div>	
				</div>
            </div>
...
//document.getElementById("divrecuprfqquote").innerHTML='<div id="divrecuprfqquote" align="center"><img src="../images_design/Spin.gif" border="0"></div>';
