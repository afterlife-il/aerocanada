                ...
                <div class="col-lg-10">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            COMPANY TYPE<a href="javascript:add_company_type()"> + Add A COMPANY TYPE</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_company_type.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									//recuperation Company Type 
									// ** tbl_Company_Type ** Fld_Company_Type_ID  Fld_Company_Type_Text
									
									$objet=new company();
									$donnee = $objet->affichage_company_type();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Company_Type_ID"]."\"><td>".$dataemp["Fld_Company_Type_ID"]."</td><td><input type='text' name='Fld_Company_Type_Text' value='".$dataemp['Fld_Company_Type_Text']."' id='Fld_Company_Type_Text".$dataemp["Fld_Company_Type_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Company_Type_ID"].")'><input type=\"hidden\" name=\"nbcompanytype\" id=\"nbcompanytype\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:sup_company_type(".$dataemp["Fld_Company_Type_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add company type-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Company_Type_Text\" id=\"Fld_Company_Type_Text\" placeholder=\"COMPANY Type\"><input type='hidden' name='nbcompanytype' value='"+nbLignes+"'>";
	
	cell = ligne.insertCell(2);
    cell.innerHTML = "<input type='submit' value='submit' class=\"form-control\">";
}
<!--End add company type-->
<!--Sup company type-->
function sup_company_type(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_company_type.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Company_Type_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp company type-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Company_Type_Text"+id).value;
    $.get('majcompanytype.php', { // lien de la page qui permet la suppression
                Fld_Company_Type_ID:id,Fld_Company_Type_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
