                ...
                <div class="col-lg-10">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            RFQ PRIORITY<a href="javascript:add_rfq_priority()"> + Add A RFQ PRIORITY</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_rfq_priority.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									$objet=new rfq();
									$donnee = $objet->affichage_rfq_priority();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Priority_ID"]."\"><td>".$dataemp["Fld_Priority_ID"]."</td><td><input type='text' name='Fld_Priority_Text' value='".$dataemp['Fld_Priority_Text']."' id='Fld_Priority_Text".$dataemp["Fld_Priority_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Priority_ID"].")'><input type=\"hidden\" name=\"nbrrfqpriority\" id=\"nbrrfqpriority\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:sup_rfq_priority(".$dataemp["Fld_Priority_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add currency-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Priority_Text\" id=\"Fld_Priority_Text\" placeholder=\"RFQ PRIORITY\"><input type='hidden' name='nbrrfqpriority' value='"+nbLignes+"'>";
...
<!--End add currency-->
<!--Sup currency-->
function sup_rfq_priority(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_rfq_priority.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Priority_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp currency-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Priority_Text"+id).value;
    $.get('majrfqpriority.php', { // lien de la page qui permet la suppression
                Fld_Priority_ID:id,Fld_Priority_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
