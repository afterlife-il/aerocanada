                ...
                <div class="col-lg-10">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            RFQ CONDITIONS<a href="javascript:add_rfq_condition()"> + Add A RFQ CONDITION</a>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div class="table-responsive">
							<form action='validation_rfq_condition.php' method="post">
                                <table class="table table-striped table-bordered table-hover" id="mytable">
									...
									$objet=new rfq();
									$donnee = $objet->affichage_rfq_conditions();
									foreach($donnee as $dataemp)
									{
									$z++;
									$varsuivante=$z+1;
								
                                       echo "<tr class=\"odd gradeX\" id=\"row_".$dataemp["Fld_Condition_ID"]."\"><td>".$dataemp["Fld_Condition_ID"]."</td><td><input type='text' name='Fld_Condition_Text' value='".$dataemp['Fld_Condition_Text']."' id='Fld_Condition_Text".$dataemp["Fld_Condition_ID"]."' onmouseleave='javascript:majtarea(".$dataemp["Fld_Condition_ID"].")'><input type=\"hidden\" name=\"nbrrfqcondition\" id=\"nbrrfqcondition\" value=\"".$z."\"></td>";
									   echo "<td><a href='javascript:sup_rfq_condition(".$dataemp["Fld_Condition_ID"].",".$z.")' onClick=\"return(confirm('Etes vous sur ?'));\"><img src='images/bin-blue-full-icon.png' border='0' width='27'></a></td>";
									   echo "</tr>";
									}?>       
                                    </tbody>
                                </table>
...
<!--Add RFQ Conditions-->
    ...
    //cell.innerHTML = "Ligne " + nbLignes + " Cellule 0";
    cell.innerHTML = "<input class=\"form-control\" name=\"Fld_Condition_Text\" id=\"Fld_Condition_Text\" placeholder=\"RFQ Conditions\"><input type='hidden' name='nbrrfqcondition' value='"+nbLignes+"'>";
	
	cell = ligne.insertCell(2);
    cell.innerHTML = "<input type='submit' value='submit' class=\"form-control\">";
}
<!--End add RFQ Conditions-->
<!--Sup RFQ Conditions-->
function sup_rfq_condition(id,nbligne){
        if (id > 0) {
            ...
            $.get('del_rfq_condition.php', { // lien de la page qui permet la suppression
			...
			document.getElementById("Fld_Condition_Text"+nbligne).value = '0';
        }
    }
<!--Fin Supp RFQ Conditions-->
function majtarea(id){
 
    var selection = document.getElementById("Fld_Condition_Text"+id).value;
    $.get('majrfqconditions.php', { // lien de la page qui permet la suppression
                Fld_Condition_ID:id,Fld_Condition_Text:selection //variable de type GET (on recuperera la variable avec $_GET['idsup'])
            }, function(data){
