<?php
$fop = fopen('csv/Inventaire-Tarmac-856-Dec17.csv', 'r');
if($fop === false)
{
...
//ITEM;DESCRIPTION;P/N TARMAC;S/N TARMAC;Qty;BOX;CUSTOMER;SV;SCRAP;entry date;release date;A/C msn;Location;Sloc;CERTIFICATE Nø;SHIPPED UNDER
		if ($varoy=='3') $Fld_Part_Nbr=$val;
		if ($varoy=='2') $FLD_PART_DESC=$val;
		if ($varoy=='4') $SN=$val;
		if ($varoy=='5') $QTY=$val;
		if ($varoy=='8') $SV=$val;
		if ($varoy=='10') $entry_date=$val;
		if ($varoy=='12') $ac_msn=$val;
		if ($varoy=='15') $certificate=$val;
		
		$Fld_Stock_Remark ="Entry date :".$entry_date."<br>";
		$Fld_Stock_Remark .="A/C msn :".$ac_msn."<br>";
		$Fld_Stock_Remark .="CERTIFICATE :".$certificate;
							//model avion 	
							//Model : A340
							$Fld_AC_ID='8';
							//Fin model avion 	
							...
							//FIN COMPANY Fld_Company_ID
								...
								//condition
								if(!empty($SV)) $Fld_Condition_ID=1;
								else $Fld_Condition_ID=4;
								//condition
								...
								$req="INSERT INTO `tbl_Stock_external` (`Fld_Stock_externe_ID`, `Fld_Part_ID`, `Fld_Part_SN`, `Fld_Supplier_ID`, `Fld_Entry_Date`, `Fld_Part_Price`, `Fld_Price_Currency_ID`, `Fld_BAX_PO_Nbr`, `Fld_Supplier_order_Date`, `Fld_Supplier_Payment_Date`, `Fld_Qty`, `Fld_Condition_ID`, `Fld_Release_ID`, `Fld_Tag_Info_ID`, `Fld_Tag_Date`, `Fld_Traceability_ID`, `Fld_Warehouse_Location`, `Fld_Physical_Stock`, `Fld_Owner_ID`, `Fld_Stock_Location_ID`, `Fld_Status_ID`, `Fld_Status_Ind`, `Fld_Status_Date`, `Fld_Stock_Remark`, `Fld_Shelf_Life_Limit`, `Fld_Valeur_Comptable`, `Fld_Valeur_Comptable_currency_Id`, `Fld_Sales_Remark`, `Fld_External_Location`, `Fld_Sales_Remark_ID`, `Fld_Warehouse_Location_ID`, `Fld_OriginalUnit_Stock_ID`, `Fld_Min_Qty`, `Fld_Publish`, `status`, `Fld_AC_ID`, `Fld_Company_ID`) VALUES ('', '".$Fld_Part_ID."', '".$SN."', NULL, '".$today."', NULL, NULL, NULL, NULL, NULL, '".$QTY."', '".$Fld_Condition_ID."', NULL, NULL, '".$DATE."', NULL, NULL, NULL, NULL, '15', NULL, NULL, NULL, '".$Fld_Stock_Remark."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '".$Fld_AC_ID."', '".$Fld_Company_ID."');"; 
									// echo $req."<br><br>";
