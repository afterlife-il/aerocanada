...
*/
					...
					//Fin recuperation du nom du aircraft
                                            ...
                                            echo "<tr><td>".$datastex['Fld_Stock_externe_ID']."</td><td>".$data["Fld_Part_Nbr"]."</td><td>".$data['Fld_Part_Desc']."</td><td>".$Aircraft_modelse."</td><td>".$datastex['Fld_Qty']."</td><td>".$datac['Fld_Condition_Text']."</td><td>".$datacn['Fld_Company_Name']."</td></tr>";
					}
?>					
			...
			<div class="row">
                <div class="col-lg-12">
					...
					while($datarfq3 = mysqli_fetch_array($reqrfq3))
					{
                                            ...
                                            echo "<tr><td><a href=\"javascript:void(0);\" data-href=\"getContent.php?id=".$datarfq3['ID']."\" class=\"openPopup\">test</a></td><td><input type=\"radio\" name=\"rfq_choice_id\" value='".$datarfq3['ID']."' onchange=\"view_rfq('".$datarfq3['ID']."');recup_info_rfq('".$datarfq3['ID']."');\"></td><td>".$datarfq3['Fld_RFQ_ID']."</td><td>".$datarfq3['date']."</td><td>".$datarfq3['Fld_Qty']."</td><td>".$datarfq3['pn_rfq']."</td><td>".$datarfq3['description_rfq']."</td><td>".$datarfq3['Fld_Observation']."</td><td>".$datarfq3['Fld_Company_Name']."</td><td>".$datals['Fld_Contact_Name']."</td><td>".$datarfqt['Fld_RFQ_Type_Text']."</td><td>".$dataPriority['Fld_Priority_Text']."</td><td>".$dataptid['Fld_Payment_Text']."</td><td>".$datact['Fld_Condition_Text']."</td><td>".$dataemp ['Employee_Name']."</td><td>";
			...
			<div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<!--Verif si il y a des RFQ pour ce pn-->
						<?php
							//****tbl_capa_list****id_capa_list  Fld_Part_ID  pn  descriptioin  aircraft  ata  capability  pma  doa  der  code_oem  design_oem  id_company
							$sqlcapal="SELECT * from tbl_capa_list where Fld_Part_ID='".$_GET['part_id']."'";
							//echo $sqlcapal;
