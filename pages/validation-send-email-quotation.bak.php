...
// ======================================================================
// 4. RÉCUP COMPTE GMAIL EMPLOYÉ + PHPMailer
// ======================================================================

//$addCC = isset($_POST['emailcc']) ? $_POST['emailcc'] : '';
...
// --- PATCH compatibilité PHP 8 : quoted_printable_encode manquante ---
if (!function_exists('quoted_printable_encode')) {
    function quoted_printable_encode($str) {
        // Encode tous les caractères non imprimables en =XX
        return preg_replace_callback(
            '/[^\x09\x20\x21-\x3C\x3E-\x7E]/',
            function ($m) {
...
// --- PATCH compatibilité PHP 8 : each() manquante (utilisée par PHPMailer-FE) ---
if (!function_exists('each')) {
    function each(&$array) {
        ...
        next($array);
        // même structure de retour que l’ancienne fonction each()
...
/**
 * Envoie un email via Gmail / PHPMailer-FE
...
function smtpMailer(
    ...
    // Expéditeur = employé
    $mail->From     = $emailemplo;
    $mail->FromName = $employeeName;
