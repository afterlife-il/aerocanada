<?php
$fop = fopen('csv/Surplus_list_FS_10192018_fokker.csv', 'r');
if($fop === false)
{
...
//Partnumber;Description;NE;SV;OH;AI;SR;Applicability
		...
		if ($varoy=='6') $AI=$val;
		if ($varoy=='7') $SR=$val;
		if ($varoy=='8') $Applicability=$val;
		
		$entry_date="2018-10-23";
		$QTY=$NE+$SV+$OH+$AI+$SR;
		$Fld_Stock_Remark ="CONDITION :<br>";
		if ($NE!='0')$Fld_Stock_Remark .="NE :".$NE."<br>";
		if ($SV!='0')$Fld_Stock_Remark .="SV :".$SV."<br>";
		if ($OH!='0')$Fld_Stock_Remark .="OH :".$OH."<br>";
		if ($AI!='0')$Fld_Stock_Remark .="AI :".$AI."<br>";
		if ($SR!='0')$Fld_Stock_Remark .="SR :".$SR."<br>";
		$Fld_Stock_Remark .="Applicability :".$Applicability;
							
							//COMPANY Fld_Company_ID -- FOKKER
							$Fld_Company_ID="2670";
							//FIN COMPANY Fld_Company_ID
								...
								$req="INSERT INTO `tbl_Stock_external` (`Fld_Stock_externe_ID`, `Fld_Part_ID`, `Fld_Part_SN`, `Fld_Supplier_ID`, `Fld_Entry_Date`, `Fld_Part_Price`, `Fld_Price_Currency_ID`, `Fld_BAX_PO_Nbr`, `Fld_Supplier_order_Date`, `Fld_Supplier_Payment_Date`, `Fld_Qty`, `Fld_Condition_ID`, `Fld_Release_ID`, `Fld_Tag_Info_ID`, `Fld_Tag_Date`, `Fld_Traceability_ID`, `Fld_Warehouse_Location`, `Fld_Physical_Stock`, `Fld_Owner_ID`, `Fld_Stock_Location_ID`, `Fld_Status_ID`, `Fld_Status_Ind`, `Fld_Status_Date`, `Fld_Stock_Remark`, `Fld_Shelf_Life_Limit`, `Fld_Valeur_Comptable`, `Fld_Valeur_Comptable_currency_Id`, `Fld_Sales_Remark`, `Fld_External_Location`, `Fld_Sales_Remark_ID`, `Fld_Warehouse_Location_ID`, `Fld_OriginalUnit_Stock_ID`, `Fld_Min_Qty`, `Fld_Publish`, `status`, `Fld_AC_ID`, `Fld_Company_ID`) VALUES ('', '".$Fld_Part_ID."', NULL, NULL, '".$today."', NULL, NULL, NULL, NULL, NULL, '".$QTY."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$Fld_Stock_Remark."', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '".$Fld_Company_ID."');"; 
								echo $req."<br><br>";
