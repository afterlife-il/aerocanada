...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/v1/companies/{companyId}/360": {
      get: { tags: ["Companies"], operationId: "getCompany360", summary: "Get persistent Company identity, contacts, addresses, notes, inventory, activity, and explicit non-persistent workflow boundaries", security: [{ bearerAuth: [] }], parameters: [{ name: "companyId", in: "path", required: true, schema: { type: "string" } }], responses: { "200": { description: "Company 360 aggregate.", content: { "application/json": { schema: { $ref: "#/components/schemas/Company360Response" } } } }, "403": { $ref: "#/components/responses/Forbidden" }, "404": { $ref: "#/components/responses/NotFound" } } }
    },
    ...
    "/v1/companies/{companyId}/notes": {
      get: { tags: ["Companies"], operationId: "listCompanyNotes", security: [{ bearerAuth: [] }], parameters: [{ name: "companyId", in: "path", required: true, schema: { type: "string" } }], responses: { "200": { description: "Company notes." }, "403": { $ref: "#/components/responses/Forbidden" }, "404": { $ref: "#/components/responses/NotFound" } } },
      post: { tags: ["Companies"], operationId: "createCompanyNote", security: [{ bearerAuth: [] }], parameters: [{ name: "companyId", in: "path", required: true, schema: { type: "string" } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/CompanyNoteCreateRequest" } } } }, responses: { "201": { description: "Note created." }, "400": { $ref: "#/components/responses/ValidationError" }, "403": { $ref: "#/components/responses/Forbidden" } } }
    },
    "/v1/company-notes/{id}": {
      patch: { tags: ["Companies"], operationId: "updateCompanyNote", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }], requestBody: { required: true, content: { "application/json": { schema: { $ref: "#/components/schemas/CompanyNoteUpdateRequest" } } } }, responses: { "200": { description: "Note updated." }, "404": { $ref: "#/components/responses/NotFound" } } },
      delete: { tags: ["Companies"], operationId: "deleteCompanyNote", security: [{ bearerAuth: [] }], parameters: [{ name: "id", in: "path", required: true, schema: { type: "string" } }], responses: { "200": { description: "Note deleted." }, "404": { $ref: "#/components/responses/NotFound" } } }
    },
  ...
  components: {
    ...
    schemas: {
      ...
      CompanyNoteCreateRequest: { type: "object", required: ["body"], properties: { body: { type: "string", minLength: 1, maxLength: 5000 }, pinned: { type: "boolean" } } },
      CompanyNoteUpdateRequest: { type: "object", minProperties: 1, properties: { body: { type: "string", minLength: 1, maxLength: 5000 }, pinned: { type: "boolean" } } },
      Company360Response: {
        type: "object", required: ["data"], properties: { data: { type: "object", required: ["company", "contacts", "addresses", "notes", "inventory", "documents", "activity", "workflowBoundaries"], properties: { company: { type: "object" }, contacts: { type: "array", items: { type: "object" } }, addresses: { type: "array", items: { type: "object" } }, notes: { type: "array", items: { type: "object" } }, inventory: { type: "array", items: { type: "object" } }, documents: { type: "object", required: ["persistent", "source", "documents"], properties: { persistent: { type: "boolean", const: false }, source: { type: "string", const: "workflow-boundary" }, documents: { type: "array", maxItems: 0 } } }, activity: { type: "array", items: { type: "object" } }, workflowBoundaries: { type: "array", items: { type: "object", required: ["category", "status", "futureOwner", "requiredData", "contextChecks", "persistence"] } } } } }
      },
      Company: {
        type: "object",
