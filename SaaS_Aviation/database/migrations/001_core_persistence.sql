...
CREATE TABLE IF NOT EXISTS part_numbers (
  ...
  created_by text NOT NULL,
  updated_by text NOT NULL,
  UNIQUE (tenant_id, normalized_part_number, COALESCE(manufacturer_code, manufacturer, ''))
);
...
CREATE TABLE IF NOT EXISTS stock_items (
  ...
  tenant_id text NOT NULL REFERENCES tenants(id),
  legacy_id text,
  part_id text NOT NULL REFERENCES part_numbers(id),
  serial_number text,
  ...
  tag_info_company_id text REFERENCES companies(id),
  traceability_company_id text REFERENCES companies(id),
